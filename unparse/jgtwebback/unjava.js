...
function GetDocAttributesFromHeading(docattributes)
{
    ...
    var ndate = parseInt(date.substr(8, 10));
    var nmonth = parseInt(date.substr(5, 7));
    var snmonth = date.slice(5, 7);
    var smonth = monthlist[nmonth - 1];
    var syear = date.slice(0, 4);
    docattributes["longdate"] = " " + ndate + " " + smonth + " " + syear;
...
function wikival(docattributes)
{
    ...
    res += monthlist[parseInt(docattributes["date"].slice(5, 7)) - 1];
    res += "]] [[";
